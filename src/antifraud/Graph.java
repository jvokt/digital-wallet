...
public class Graph {
	...
	HashMap<String,HashSet<String>> degree2Neighbors;
	HashMap<String,HashSet<String>> degree3Neighbors;
	HashMap<String,HashSet<String>> degree4Neighbors;
	
	public Graph() {
		adjacencyList = new HashMap<>();
		degree2Neighbors = new HashMap<>();
		degree3Neighbors = new HashMap<>();
		degree4Neighbors = new HashMap<>();
	}
