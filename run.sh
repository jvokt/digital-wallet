...
javac ./src/antifraud/BloomFilter.java
javac -cp ./src ./src/antifraud/Graph.java
javac -cp ./src ./src/antifraud/Antifraud.java
java -cp ./src antifraud.Antifraud ./paymo_input/batch_payment.txt ./paymo_input/stream_payment.txt ./paymo_output/output1.txt ./paymo_output/output2.txt ./paymo_output/output3.txt
